 ...
 */
/**
 * ✅ SOLUCIÓN: Watch mejorado con debounce implícito
 * Monitorea cambios en los filtros y recarga la lista
 */
watch(
    () => [searchQuery.value, selectedDriverStatus.value, selectedLicenseStatus.value],
    () => {
